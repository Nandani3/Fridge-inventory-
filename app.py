...
# # Sidebar for developer details
 #with st.sidebar:
     ...
     #st.markdown("**Name**: Nandani Bisht")
     #st.markdown("**Email**: [bishtnandani025@gmail.com](mailto:bishtnandani025@gmail.com)")
     #st.markdown("**LinkedIn**: [Nandani Bisht](https://www.linkedin.com/in/nandani-bisht-03344024a/)")
     #st.markdown("---") 
...
#    - Estimate the quantity of each item (e.g., "2 apples", "1 bottle", "approx. 500ml remaining").
